<?php
    ...
    $items = [
        ...
        "toys" => [
            ...
            new Toy("https://static.vecteezy.com/ti/vettori-gratis/p1/47281776-realistico-animale-domestico-gatto-cane-illustrazione-concetti-vettoriale.jpg", "Dog Disc", 7.00, $animals["dog"], "Giochi educativi", "Dog Disc è un simpatico frisbee per cani, realizzato in plastica flessibile. Ideale per l'addestramento.", false, 4.5)
        ],
        "kennels" => [
